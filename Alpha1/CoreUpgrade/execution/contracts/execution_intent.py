...
class ExecutionIntent:
    ...
    def __post_init__(self):
        ...
        # Hardening: Reject zero-quantity actions to prevent log pollution
        if self.delta_quantity == Decimal("0"):
            raise ValueError(
                "ExecutionIntent invariant violated: ExecutionIntent cannot represent a zero quantity action."
            )
